...
contract Dnom {
    ...
    constructor(uint16 registrationPeriod, uint16 delegationPeriodStart, uint16 delegationPeriodEnd, uint16 genesisPeriodStart, uint16 genesisPeriodEnd, uint16 genesisPeriodEndForValidators) public {
        ...
        dnomGenesisContract = new DnomGenesis(dnomGenesisValidatorContract, genesisPeriodStart, genesisPeriodEnd, genesisPeriodEndForValidators);
    }
}
